...
export const SPRITE_TO_SVG_ELEMENT_MAP = {
  ...
  TCR_1: <TCR1 id="TCR_1" />,
  TCR_2: <TCR2 id="TCR_2" />,
  BCR_IgA_Dimer: <BCRIgADimer id="BCR_IgA_Dimer" />,
  BCR_IgA: <BCRIgA id="BCR_IgA" />,
  BCR_IgD: <BCRIgD id="BCR_IgD" />,
  BCR_IgE: <BCRIgE id="BCR_IgE" />,
  BCR_IgE_2: <BCRIgE2 id="BCR_IgE_2" />,
  BCR_IgG_flexible_1: <BCRIgGFlexible1 id="BCR_IgG_flexible_1" />,
  BCR_IgG_flexible_2: <BCRIgGFlexible2 id="BCR_IgG_flexible_2" />,
  BCR_IgG: <BCRIgG id="BCR_IgG" />,
